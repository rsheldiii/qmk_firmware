...
#define RGBMODE LT(SYMB, RGB_MODE_FORWARD)
#define RGBTOGL LT(FUNCTION, RGB_TOG)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    MO(FUNCTION),   KC_TRNS, KC_LGUI, KC_LALT, KC_LCTL,  KC_LSFT,  KC_LCTL,  KC_ENT, KC_SPACE, KC_LEFT,  KC_UP,   KC_DOWN, KC_RGHT, KC_TRNS \
  ),
  ...
  [FUNCTION] = LAYOUT( \
    ...
    _______, RGB_HUD, RGB_VAD, RGB_HUI, VLK_TOG, _______,                   _______,           KC_LEFT,  KC_DOWN, KC_RGHT, KC_DEL,  KC_END,  \
    KC_LSFT, _______, _______, _______, _______, _______,                   MAGIC_TOGGLE_NKRO, _______,  _______, KC_MPLY, KC_MPRV, KC_MNXT, \
    KC_TRNS, KC_LGUI, KC_LALT, RGB_MOD, RGB_TOG, _______, _______, _______, _______,           RGB_TOG,  RGB_MOD, KC_MUTE, KC_VOLU, KC_VOLD \
  ),
