...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_ESC, KC_1, KC_NO, KC_LEFT, KC_RGHT, KC_U, KC_SPC, KC_TAB, KC_9, KC_SCLN,
        KC_BSPC, KC_LCTL, KC_K, KC_I, KC_NO, KC_SLSH, KC_BSLS, KC_NO, KC_H, KC_UP,
        KC_CAPS, KC_LSFT, KC_P, KC_QUOT, KC_6, KC_8, KC_RSFT, KC_M, KC_5, KC_3,
        KC_NO, KC_NO, KC_7, KC_O, KC_J, KC_4, KC_Q, KC_W, KC_E, KC_R,
        KC_T, KC_A, KC_S, KC_D, KC_F, KC_G, KC_Z, KC_X, KC_C, KC_V,
        KC_B, KC_0, KC_LALT, KC_N, KC_DOWN, KC_ENT, KC_DOT, KC_Y, KC_COMM, KC_LGUI,
        KC_L, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    )
};
