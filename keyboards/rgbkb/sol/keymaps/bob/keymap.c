...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    MO(_SYMB),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G, KC_LPRN, KC_RPRN,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, \
      KC_TRNS,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_LCBR, KC_RCBR,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_ENT, \
MO(_FUNCTION), KC_TRNS, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_LCTL,  KC_ENT,  KC_SPC, KC_LEFT,  KC_UP,   KC_DOWN, KC_RGHT, KC_TRNS, \
  ...
  [_SYMB] = LAYOUT( \
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, _______, _______, _______, \
    _______, _______, _______, KC_EQL,  KC_MINS, _______, _______, _______, _______,  KC_LBRC,  KC_RBRC, _______, _______, _______,  \
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______, _______, _______, _______, \
                                                 _______, _______, _______, _______\
  ),
